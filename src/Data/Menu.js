...
export const journalItems = [
  { name: "History Of Design", link: "/journal/history" },
  { name: "Bags, Belt, Accessories", link: "/journal/bags-belt-accessories" },
  { name: "Moments Of Production", link: "/journal/production" },
  { name: "Achievements", link: "/journal/achievements" },
  { name: "Campaigns", link: "/journal/campaigns" },
];

export const Inspiration = [
  { name: "Upcoming Design", link: "/inspiration/upcoming-design" },
];
