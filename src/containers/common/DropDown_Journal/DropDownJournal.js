...
export const Dropdown2 = ({ title, items, isVisible, closeDropdown, dropdownRef }) => {
          ...
          <div className="">
            <ul className=" gap-5 flex justify-center items-center">
              <li className="text-[0.6rem]">
                <p className="text-gray-700 text-sm cursor-pointer hover:border-b-2">Hero Style</p>
                <div className="relative overflow-hidden">
                  <img className="mt-3 cursor-pointer h-48" src="images/brand-history.jpeg" alt="news" />
                </div>
              </li>
              <li className="text-[0.6rem]">
              <p className="text-gray-700 text-sm cursor-pointer hover:border-b-2">Independent</p>
                <div className="relative overflow-hidden">
